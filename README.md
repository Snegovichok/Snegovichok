...
- 🏹 Huntress "ZENICA" (the apple of my eye) is a machine learning-based system for automatic detection and multiclass semantic classification of socially dangerous and fraudulent patterns in Russian-language texts.
